...
* The original package name '.TwitterClone-Backend' is invalid and this project uses 'TwitterCloneBackend' instead.

# Getting Started

1. Open in intelliJ
2. Run as gradle application
3. 2 end points: localhost:8087/register and localhost:8087/login
